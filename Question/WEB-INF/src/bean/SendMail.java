...
public class SendMail {
	...
	private static final String IP_ADDRESS = "smtp.kanda-it-school-system.com";
	private static final String DEFAULT_CODE_TYPE = "iso-2022-jp";

	private final Properties props = System.getProperties();
	private final Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
